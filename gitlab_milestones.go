...
func (f *gitLabForge) Milestones() MilestoneService {
	return &gitLabMilestoneService{client: f.client}
}

func convertGitLabMilestone(m *gitlab.Milestone) Milestone {
	result := Milestone{
		Title:       m.Title,
		Number:      int(m.ID),
...
func (s *gitLabMilestoneService) List(ctx context.Context, owner, repo string, opts ListMilestoneOpts) ([]Milestone, error) {
	pid := owner + "/" + repo
...
func (s *gitLabMilestoneService) Get(ctx context.Context, owner, repo string, id int) (*Milestone, error) {
	pid := owner + "/" + repo
...
func (s *gitLabMilestoneService) Create(ctx context.Context, owner, repo string, opts CreateMilestoneOpts) (*Milestone, error) {
	pid := owner + "/" + repo
...
func (s *gitLabMilestoneService) Update(ctx context.Context, owner, repo string, id int, opts UpdateMilestoneOpts) (*Milestone, error) {
	pid := owner + "/" + repo
