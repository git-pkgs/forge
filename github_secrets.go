...
func (f *gitHubForge) Secrets() SecretService {
	return &gitHubSecretService{client: f.client}
}

func (s *gitHubSecretService) List(ctx context.Context, owner, repo string, opts ListSecretOpts) ([]Secret, error) {
...
func (s *gitHubSecretService) Set(ctx context.Context, owner, repo string, opts SetSecretOpts) error {
