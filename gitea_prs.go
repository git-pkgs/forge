...
func (f *giteaForge) PullRequests() PullRequestService {
...
func (s *giteaPRService) Get(ctx context.Context, owner, repo string, number int) (*PullRequest, error) {
...
func (s *giteaPRService) List(ctx context.Context, owner, repo string, opts ListPROpts) ([]PullRequest, error) {
...
func (s *giteaPRService) Create(ctx context.Context, owner, repo string, opts CreatePROpts) (*PullRequest, error) {
...
func (s *giteaPRService) Update(ctx context.Context, owner, repo string, number int, opts UpdatePROpts) (*PullRequest, error) {
...
func (s *giteaPRService) Merge(ctx context.Context, owner, repo string, number int, opts MergePROpts) error {
...
func (s *giteaPRService) CreateComment(ctx context.Context, owner, repo string, number int, body string) (*Comment, error) {
...
func (s *giteaPRService) ListComments(ctx context.Context, owner, repo string, number int) ([]Comment, error) {
	var all []Comment
	page := 1
	for {
