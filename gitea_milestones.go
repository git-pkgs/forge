...
func (f *giteaForge) Milestones() MilestoneService {
	return &giteaMilestoneService{client: f.client}
}

func convertGiteaMilestone(m *gitea.Milestone) Milestone {
	result := Milestone{
		Title:       m.Title,
		Number:      int(m.ID),
...
func (s *giteaMilestoneService) List(ctx context.Context, owner, repo string, opts ListMilestoneOpts) ([]Milestone, error) {
...
func (s *giteaMilestoneService) Get(ctx context.Context, owner, repo string, id int) (*Milestone, error) {
...
func (s *giteaMilestoneService) Create(ctx context.Context, owner, repo string, opts CreateMilestoneOpts) (*Milestone, error) {
...
func (s *giteaMilestoneService) Update(ctx context.Context, owner, repo string, id int, opts UpdateMilestoneOpts) (*Milestone, error) {
