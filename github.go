...
func (f *gitHubForge) Repos() RepoService {
...
func (s *gitHubRepoService) Get(ctx context.Context, owner, repo string) (*Repository, error) {
...
func (s *gitHubRepoService) List(ctx context.Context, owner string, opts ListRepoOpts) ([]Repository, error) {
...
func (s *gitHubRepoService) listOrgRepos(ctx context.Context, owner string, perPage int) ([]Repository, error) {
	var all []Repository
...
func (s *gitHubRepoService) listUserRepos(ctx context.Context, owner string, perPage int) ([]Repository, error) {
	var all []Repository
...
func (s *gitHubRepoService) Create(ctx context.Context, opts CreateRepoOpts) (*Repository, error) {
...
func (s *gitHubRepoService) Edit(ctx context.Context, owner, repo string, opts EditRepoOpts) (*Repository, error) {
	ghRepo := &github.Repository{}
	changed := false
...
func (s *gitHubRepoService) Fork(ctx context.Context, owner, repo string, opts ForkRepoOpts) (*Repository, error) {
...
func (s *gitHubRepoService) ListTags(ctx context.Context, owner, repo string) ([]Tag, error) {
	var allTags []Tag
...
func (s *gitHubRepoService) Search(ctx context.Context, opts SearchRepoOpts) ([]Repository, error) {
	perPage := opts.PerPage
	if perPage <= 0 {
		perPage = 30
	}
