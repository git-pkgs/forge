...
func (f *gitHubForge) Issues() IssueService {
...
func convertGitHubComment(c *github.IssueComment) Comment {
	result := Comment{
		ID:   c.GetID(),
		Body: c.GetBody(),
...
func (s *gitHubIssueService) Get(ctx context.Context, owner, repo string, number int) (*Issue, error) {
...
func (s *gitHubIssueService) List(ctx context.Context, owner, repo string, opts ListIssueOpts) ([]Issue, error) {
...
func (s *gitHubIssueService) Create(ctx context.Context, owner, repo string, opts CreateIssueOpts) (*Issue, error) {
...
func (s *gitHubIssueService) Update(ctx context.Context, owner, repo string, number int, opts UpdateIssueOpts) (*Issue, error) {
	req := &github.IssueRequest{}
	changed := false
...
func (s *gitHubIssueService) CreateComment(ctx context.Context, owner, repo string, number int, body string) (*Comment, error) {
...
func (s *gitHubIssueService) ListComments(ctx context.Context, owner, repo string, number int) ([]Comment, error) {
	var all []Comment
