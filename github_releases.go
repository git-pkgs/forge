...
func (f *gitHubForge) Releases() ReleaseService {
	return &gitHubReleaseService{client: f.client}
}

func convertGitHubRelease(r *github.RepositoryRelease) Release {
	result := Release{
...
func (s *gitHubReleaseService) List(ctx context.Context, owner, repo string, opts ListReleaseOpts) ([]Release, error) {
...
func (s *gitHubReleaseService) Get(ctx context.Context, owner, repo, tag string) (*Release, error) {
...
func (s *gitHubReleaseService) GetLatest(ctx context.Context, owner, repo string) (*Release, error) {
...
func (s *gitHubReleaseService) Create(ctx context.Context, owner, repo string, opts CreateReleaseOpts) (*Release, error) {
...
func (s *gitHubReleaseService) Update(ctx context.Context, owner, repo, tag string, opts UpdateReleaseOpts) (*Release, error) {
...
func (s *gitHubReleaseService) UploadAsset(ctx context.Context, owner, repo, tag string, file *os.File) (*ReleaseAsset, error) {
	existing, resp, err := s.client.Repositories.GetReleaseByTag(ctx, owner, repo, tag)
	if err != nil {
		if resp != nil && resp.StatusCode == http.StatusNotFound {
			return nil, ErrNotFound
