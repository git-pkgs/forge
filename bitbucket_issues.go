...
func (f *bitbucketForge) Issues() IssueService {
...
func convertBitbucketIssue(bb bbIssue) Issue {
	result := Issue{
		Number:  bb.ID,
		Title:   bb.Title,
		Body:    bb.Content.Raw,
...
func convertBitbucketComment(bb bbComment) Comment {
	result := Comment{
		ID:      int64(bb.ID),
		Body:    bb.Content.Raw,
		HTMLURL: bb.Links.HTML.Href,
...
func (s *bitbucketIssueService) Get(ctx context.Context, owner, repo string, number int) (*Issue, error) {
...
func (s *bitbucketIssueService) List(ctx context.Context, owner, repo string, opts ListIssueOpts) ([]Issue, error) {
...
func (s *bitbucketIssueService) Create(ctx context.Context, owner, repo string, opts CreateIssueOpts) (*Issue, error) {
	body := map[string]any{
		"title": opts.Title,
...
func (s *bitbucketIssueService) Update(ctx context.Context, owner, repo string, number int, opts UpdateIssueOpts) (*Issue, error) {
	body := map[string]any{}
	if opts.Title != nil {
...
func (s *bitbucketIssueService) CreateComment(ctx context.Context, owner, repo string, number int, body string) (*Comment, error) {
...
func (s *bitbucketIssueService) ListComments(ctx context.Context, owner, repo string, number int) ([]Comment, error) {
