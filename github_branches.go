...
func (f *gitHubForge) Branches() BranchService {
	return &gitHubBranchService{client: f.client}
}

func (s *gitHubBranchService) List(ctx context.Context, owner, repo string, opts ListBranchOpts) ([]Branch, error) {
...
func (s *gitHubBranchService) Create(ctx context.Context, owner, repo, name, from string) (*Branch, error) {
