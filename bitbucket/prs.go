...
func (f *bitbucketForge) PullRequests() forge.PullRequestService {
...
func convertBitbucketPR(bb bbPullRequest) forge.PullRequest {
...
func (s *bitbucketPRService) Get(ctx context.Context, owner, repo string, number int) (*forge.PullRequest, error) {
...
func (s *bitbucketPRService) List(ctx context.Context, owner, repo string, opts forge.ListPROpts) ([]forge.PullRequest, error) {
...
func (s *bitbucketPRService) Create(ctx context.Context, owner, repo string, opts forge.CreatePROpts) (*forge.PullRequest, error) {
	body := map[string]any{
		"title":       opts.Title,
...
func (s *bitbucketPRService) Update(ctx context.Context, owner, repo string, number int, opts forge.UpdatePROpts) (*forge.PullRequest, error) {
	body := map[string]any{}
	if opts.Title != nil {
...
func (s *bitbucketPRService) Merge(ctx context.Context, owner, repo string, number int, opts forge.MergePROpts) error {
	body := map[string]any{}
	if opts.Method != "" {
...
func (s *bitbucketPRService) ListComments(ctx context.Context, owner, repo string, number int) ([]forge.Comment, error) {
