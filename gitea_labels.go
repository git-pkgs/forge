...
func (f *giteaForge) Labels() LabelService {
	return &giteaLabelService{client: f.client}
}

func convertGiteaLabel(l *gitea.Label) Label {
	return Label{
		Name:        l.Name,
		Color:       l.Color,
...
func (s *giteaLabelService) List(ctx context.Context, owner, repo string, opts ListLabelOpts) ([]Label, error) {
...
func (s *giteaLabelService) Get(ctx context.Context, owner, repo, name string) (*Label, error) {
...
func (s *giteaLabelService) Create(ctx context.Context, owner, repo string, opts CreateLabelOpts) (*Label, error) {
...
func (s *giteaLabelService) Update(ctx context.Context, owner, repo, name string, opts UpdateLabelOpts) (*Label, error) {
