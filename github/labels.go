...
func (f *gitHubForge) Labels() forge.LabelService {
	return &gitHubLabelService{client: f.client}
}

func convertGitHubLabel(l *github.Label) forge.Label {
	return forge.Label{
		Name:        l.GetName(),
		Color:       l.GetColor(),
...
func (s *gitHubLabelService) List(ctx context.Context, owner, repo string, opts forge.ListLabelOpts) ([]forge.Label, error) {
...
func (s *gitHubLabelService) Get(ctx context.Context, owner, repo, name string) (*forge.Label, error) {
...
func (s *gitHubLabelService) Create(ctx context.Context, owner, repo string, opts forge.CreateLabelOpts) (*forge.Label, error) {
...
func (s *gitHubLabelService) Update(ctx context.Context, owner, repo, name string, opts forge.UpdateLabelOpts) (*forge.Label, error) {
	ghLabel := &github.Label{}
	changed := false
